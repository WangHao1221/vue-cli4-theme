...
export const login = params => {
    return axios.post(`${axios.AUTH_BASE_API}/oauth/token`, params, {
...
//获取Token
export const getToken = (usreId, code) => {
        return axios.get(`${axios.AUTH_BASE_API}/checkOauth/${usreId}/${code}`).then(res => res)
    }
    //获取用户信息
export const getUserInfo = params => {
        return axios.get(`${axios.MANAGE_BASE_API}/sysSystemType/find?id=` + params).then(res => res)
    }
    //根据用户id获取密码修改提示
